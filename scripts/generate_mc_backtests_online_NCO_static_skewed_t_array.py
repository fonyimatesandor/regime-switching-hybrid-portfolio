...
if len(sys.argv) < 2:
    print("Usage: python -m scripts.generate_mc_backtests_online_NCO_static_skewed_t_array <array_index>")
    sys.exit(1)
...
print(f"Array job for online model_1: {model_1_name} | Running {len(filtered_models)} models")
...
json.dump(
    ...
    open(f"data/mc_metrics/mc_backtest_summary_NCO_{simulator_name}_{model_1_name}.json", "w"),
    indent=4,
)
