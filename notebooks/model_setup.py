...
from src.models.NCO import NestedClusteredOptimizationPortfolio
...
for model_1 in choosen_classical_models:
    for model_2 in choosen_classical_models:
