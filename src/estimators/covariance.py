...
class HistoricalCovarianceEstimator(CovarianceEstimator):
    """Covariance estimator that uses the sample covariance of returns over the lookback period."""
...
class LedoitWolfCovarianceEstimator(CovarianceEstimator):
    """Covariance estimator that uses the Ledoit-Wolf shrinkage estimator."""
...
class FactorCovarianceEstimator(CovarianceEstimator):
    """Covariance estimator that uses a factor model to estimate the covariance matrix."""
...
class EWMACovarianceEstimator(CovarianceEstimator):
    """Covariance estimator that uses an exponentially weighted moving average (EWMA) to estimate the covariance matrix."""
